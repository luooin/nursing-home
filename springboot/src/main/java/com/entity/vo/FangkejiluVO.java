 ...
 */
public class FangkejiluVO  implements Serializable {
	...
	public void setFangwenshijian(Date fangwenshijian) {
		this.fangwenshijian = fangwenshijian;
	}
	
	/**
	 * 获取：访问时间
	 */
	public Date getFangwenshijian() {
		return fangwenshijian;
	}

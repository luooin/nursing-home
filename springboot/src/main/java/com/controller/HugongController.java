...
public class HugongController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HugongEntity u = hugongService.selectOne(new EntityWrapper<HugongEntity>().eq("hugonggonghao", username));
    ...
    public R register(@RequestBody HugongEntity hugong){
    	...
    	HugongEntity u = hugongService.selectOne(new EntityWrapper<HugongEntity>().eq("hugonggonghao", hugong.getHugonggonghao()));
		if(u!=null) {

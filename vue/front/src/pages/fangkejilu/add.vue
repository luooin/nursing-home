    ...
    >
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="入住编号" prop="ruzhubianhao">
            <el-input v-model="ruleForm.ruzhubianhao" 
                placeholder="入住编号" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="访客姓名" prop="fangkexingming">
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="访问时间" prop="fangwenshijian" >
              <el-date-picker
                  value-format="yyyy-MM-dd HH:mm:ss"
                  v-model="ruleForm.fangwenshijian" 
                  type="datetime"
                  placeholder="访问时间">
              </el-date-picker>
          </el-form-item>
...
<script>
  export default {
    ...
    created() {
      ...
      this.ruleForm.fangwenshijian = this.getCurDateTime()
    },
    methods: {
      getMakeZero(s) {
          return s < 10 ? '0' + s : s;
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='fangwenshijian'){
              this.ruleForm.fangwenshijian = obj[o];
              this.ro.fangwenshijian = true;
              continue;
            }
          }
        }
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('fangkejilu/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('fangkejilu/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',

		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"padding":"0px","margin":"0 0 0 20px","background":"none","display":"flex","width":"100px","justifyContent":"space-between","order":"5"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0","borderColor":"#fde2db #fbccc0 #f58c71","margin":"0","textAlign":"center","display":"flex","justifyContent":"center","top":"180px","flexWrap":"wrap","left":"20px","background":"none","borderWidth":"0px","width":"calc(100% - 20px)","position":"absolute","borderStyle":"solid"}' >
					<div :style='{"width":"auto","margin":"0 10px 0 0","background":"none","display":"inline-block"}'>
						<label :style='{"padding":"0 4px 0 0","color":"#666","textAlign":"right","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">护工工号</label>
						<el-input v-model="searchForm.hugonggonghao" placeholder="护工工号" clearable></el-input>
					</div>
					<div :style='{"width":"auto","margin":"0 10px 0 0","background":"none","display":"inline-block"}'>
					...
					<div :style='{"width":"auto","margin":"0 10px 0 0","background":"none","display":"inline-block"}'>
						<label :style='{"padding":"0 4px 0 0","color":"#666","textAlign":"right","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">护工电话</label>
						<el-input v-model="searchForm.hugongdianhua" placeholder="护工电话" clearable></el-input>
					</div>
					<div :style='{"width":"auto","margin":"0 10px 0 0","background":"none","display":"inline-block"}' class="select" label="护理级别" prop="hulijibie">
						<label :style='{"padding":"0 4px 0 0","color":"#666","textAlign":"right","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">护理级别</label>
						<el-select  @change="hulijibieChange" clearable v-model="searchForm.hulijibie" placeholder="请选择护理级别">
							<el-option v-for="(item,index) in hulijibieOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="hugongzhaopian" width="200" label="护工照片">
						<template slot-scope="scope">
							<div v-if="scope.row.hugongzhaopian">
								<img v-if="scope.row.hugongzhaopian.substring(0,4)=='http'" :src="scope.row.hugongzhaopian.split(',')[0]" width="100" height="100">
								<img v-else :src="$base.url+scope.row.hugongzhaopian.split(',')[0]" width="100" height="100">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
           ...
           if(this.searchForm.hugonggonghao!='' && this.searchForm.hugonggonghao!=undefined){
            params['hugonggonghao'] = '%' + this.searchForm.hugonggonghao + '%'
          }
           ...
           if(this.searchForm.hugongdianhua!='' && this.searchForm.hugongdianhua!=undefined){
            params['hugongdianhua'] = '%' + this.searchForm.hugongdianhua + '%'
          }
           if(this.searchForm.hulijibie!='' && this.searchForm.hulijibie!=undefined){
            params['hulijibie'] = this.searchForm.hulijibie
          }
      this.$http({
        url: "hugong/page",
        method: "get",
